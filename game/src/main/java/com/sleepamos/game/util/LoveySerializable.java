...
/**
 * A value serializable by the {@link LoveySerializer}. Extending classes should declare a VERSION value annotated with {@link LoveySerializableClassVersion}, otherwise the version defaults to 0.
 *
