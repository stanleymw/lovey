package com.sleepamos.vrmodule;
...
public class VrLauncher {
    public static void main(String[] args) {
        ...
        Lovey app = new Lovey(xrState, new OpenXrActionState(manifest(), ActionSets.MAIN), new VRHandsAppState(handSpec()));
